...
systemd = {
	...
	settings.Manager =  {
		...
		"CAP_MAC_OVERRIDE"    # Bypass MAC/SELinux/SMACK enforcement #
		...
		"CAP_NET_BROADCAST"    # Make network broadcasts (rarely needed)
...
# Dangerous / process control & scheduling



# Dangerous / memory & IPC



# Dangerous / logs & system events





# Less dangerous / sandboxing / performance
		...
		NoNewPrivileges = true;	#*********************************CHECK IF BREAKING
